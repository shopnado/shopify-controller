...
import (
	...
	informers "github.com/shopnado/shopify-controller/controller/generated/informers/externalversions/shopnado.xyz"
)
...
func (g *group) V1() v1.Interface {
	return v1.New(g.controllerManager, g.client.ShopnadoV1(), g.informers.V1())
}
